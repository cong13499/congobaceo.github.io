...
$(function () {
  $(document).ready(function(){
    if($('.c-course-slider').length > 0){
      ...
      $('.c-course-slider .b-grid').matchHeight();
    }
  });
});
...
// phone register change
$(function () {
  $(document).ready(function(){
    if($('.c-phone-register').length > 0){
      $(".c-phone-register .form-control").on('change keyup paste', function() {
